...
func setupNSs() error {
	if err := createNS(mainClusterCli, ns1); err != nil {
		return err
	}

	if err := createNS(mainClusterCli, ns2); err != nil {
		return err
	}

	return createNS(extraClusterCli, ns3)
}
...
func setupPods() error {
	if err := createPod(mainClusterCli, ns1, "source", "source"); err != nil {
		return err
	}

	if err := createPod(mainClusterCli, ns1, "dest", "dest"); err != nil {
		return err
	}

	if err := createPod(mainClusterCli, ns2, "dest", "dest"); err != nil {
		return err
	}

	return createPod(extraClusterCli, ns3, "dest", "dest")
}
...
func setupPVCs() error {
	...
	if err = createPVC(mainClusterCli, ns1, "source"); err != nil {
		return err
	}

	if err = createPVC(mainClusterCli, ns1, "dest"); err != nil {
		return err
	}

	if err = createPVC(mainClusterCli, ns2, "dest"); err != nil {
		return err
	}

	return createPVC(extraClusterCli, ns3, "dest")
}

func setupPVCsWithLongName() error {
	if err := createPVC(mainClusterCli, ns1, longSourcePvcName); err != nil {
		return err
	}

	if err := createPVC(mainClusterCli, ns1, longDestPvcName); err != nil {
		return err
	}

	if err := createPod(mainClusterCli, ns1, "long-source", longSourcePvcName); err != nil {
		return err
	}

	if err := createPod(mainClusterCli, ns1, "long-dest", longDestPvcName); err != nil {
		return err
	}
...
func createPod(cli *k8s.ClusterClient, namespace string, name string, pvc string) error {
	...
	if _, err := cli.KubeClient.CoreV1().
		Pods(namespace).Create(context.TODO(), &pod, metav1.CreateOptions{}); err != nil {
...
func createPVC(cli *k8s.ClusterClient, namespace string, name string) error {
	...
	if _, err := cli.KubeClient.CoreV1().PersistentVolumeClaims(namespace).
		Create(context.TODO(), &pvc, metav1.CreateOptions{}); err != nil {
...
func createNS(cli *k8s.ClusterClient, name string) error {
	if _, err := cli.KubeClient.CoreV1().
...
func deleteNS(cli *k8s.ClusterClient, name string) error {
	...
	if err := namespaces.Delete(context.TODO(), name, metav1.DeleteOptions{}); err != nil {
