...
- **A character YAML cannot carry on one line is rejected rather than quoted.**
  ...
  That is a wider set than a newline: YAML permits no control character there except tab, and it reads two of the C1 controls and two Unicode separators as line breaks of their own.
...
Where it is about a number the data mover states outright, they refuse the line instead, because a percentage above 100 or a negative byte count is not a reading to be repaired, and a fabricated 100% reads as a completed transfer.
